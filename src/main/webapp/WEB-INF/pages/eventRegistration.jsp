...
<head>
    <title>CSS EventRegistration Form</title>
    <style>
        body {
            color: #fff;
            font-family: Arial;
            font-size: 12px;
            background-image: url(http://wallpoper.com/images/00/26/62/45/soccer-stadium_00266245.jpg);
...
<form action="" class="register">
    ...
    <fieldset class="row1">
        <legend>Event Registration Details
        </legend>
        <p>
            <label>Event Title *
            </label>
    ...
    <fieldset class="row2">
        ...
        <p>
            <label class="optional">Referee Name
            </label>
